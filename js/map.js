...
const storageData = localStorage.getItem("addresArray");
...
// const ADDRES = [
//   { add: "대구 동구 화랑로 525 영진직업전문학교", name: "영진 직업전문학교" },
//   { add: "대구 동구 화랑로 574", name: "랜드로버 서비스센터" },
//   { add: "대구 동구 동촌로 370 코지하우스", name: "코지 하우스" },
// ];
